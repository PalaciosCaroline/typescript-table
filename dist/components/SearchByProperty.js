...
var SearchByProperty = function (_a) {
    ...
    return (_jsxs("div", __assign({ style: { position: 'relative', display: 'flex', alignItems: 'center' } }, { children: [_jsx("input", { type: "text", value: (_b = inputValues[property]) !== null && _b !== void 0 ? _b : '', onChange: handleInputChange, placeholder: "Search...", name: property, className: "inputSearchByProperty" }), _jsx("button", __assign({ type: "button", className: "btnSearchByPropertyReset", onClick: handleResetClose, style: {
                    position: 'absolute',
                    top: 0,
                    right: 0,
                    width: '20px',
