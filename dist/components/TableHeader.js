...
export var TableHeader = function (_a) {
    ...
    if (!isVisible)
        return null;
    return (_jsx("th", __assign({ style: { position: 'relative' }, className: "th_tableComponent th_".concat(property, " thColor") }, { children: _jsxs("div", __assign({ className: 'box_labelAndBtnsColumn' }, { children: [_jsx("p", __assign({ className: 'label', "data-testid": "columnManaged-".concat(property, " label__tableComponent") }, { children: label })), _jsxs("div", __assign({ className: 'box_btnsColumn' }, { children: [!disableSort && (_jsx(SortButton, { isSortKey: isSortKey, sortOrder: sortOrder, property: property, handleSort: handleSort, dateFormat: dateFormat })), !disableFilter && (_jsx(SearchDropdown, { property: property, inputValues: inputValues, handleSearchByProperty: handleSearchByProperty, handleReset: handleReset }))] }))] })) }), property));
};
